#
#  Be sure to run `pod spec lint themoviedb-wrapper-spec.podspec' to ensure this is a
...
This library is the basic wrapper for The Movie DB APIs. This wrapper is written to make the use to TheMovieDB API simple. Codable models are already written in this library.
  ...
  s.author             = { "Azeem Akram" => "azeem11198@hotmail.com" }
  # Or just: s.author    = "Azeem Akram"
  # s.authors            = { "Azeem Akram" => "azeem11198@hotmail.com" }
  ...
  s.source       = { :git => "https://github.com/azeemse/themoviedb-wrapper.git", :tag => "#{s.version}" }
